        ...
        <table className="min-w-full bg-black/40 text-xs md:text-sm">
          ...
          <tbody>
            {notices.map((notice) => (
              ...
              >
                <td className="px-2 md:px-4 py-2 md:py-3 text-white">{notice.id}</td>
                <td className="px-2 md:px-4 py-2 md:py-3 text-white">{notice.title}</td>
                <td className="px-2 md:px-4 py-2 md:py-3 text-white">{notice.date}</td>
              </tr>
            ))}
          </tbody>
        </table>
