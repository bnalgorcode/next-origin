  ...
  return (
    <div>
      ...
      <div className="bg-black/60 p-4 text-white">
        ...
        <p className="mb-2">
          * <button className="bg-gradient-to-b from-[#33e1ea] via-[#0b8dad] to-[#04336d] px-1.5 py-0.5 rounded-sm font-black text-sm transition-all duration-300 hover:bg-gradient-to-t hover:from-[#33e1ea] hover:via-[#0b8dad] hover:to-[#04336d]">
            &nbsp; Account Inquiry &nbsp;
          </button>
        </p>
      ...
      <div className="bg-black/60 p-1 lg:p-4 mt-4 text-white font-bold">
        ...
        <div className="p-3 border-b border-gray-600/50">
          <label className="inline-block min-w-[150px] mb-2">Deposit Amount:</label>
          <input
            type="text"
            value={depositAmount}
        ...
        <div className="p-3 border-b border-gray-600/50">
          <label className="inline-block min-w-[150px] mb-2">Recharge Bonus:</label>
          <select
            value={selectedBonus}
        ...
        <table className="min-w-full bg-black/40">
          <thead>
            <tr className="border-b border-gray-600/50">
              ...
              <th className="px-4 py-3 text-left text-white font-bold">Deposit Amount</th>
